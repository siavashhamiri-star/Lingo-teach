  ...
  const setTemplate = (topic: TopicTemplate) => {
    ...
    switch(topic) {
        case 'business':
            ...
            break;
        case 'immigration':
            template = "Create a lesson for English for immigration purposes, specifically for an embassy interview. The lesson should cover essential vocabulary, common questions asked by visa officers (e.g., 'What is the purpose of your trip?', 'How will you finance your stay?'), and strategies for giving clear and confident answers. Include a role-playing exercise for a mock interview.";
            break;
        case 'slang':
