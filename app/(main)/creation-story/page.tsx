  ...
  const handleGenerateStory = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Listen to the legend of Afarinesh.',
      });
    } catch (error) {
              ...
              <div className="space-y-4">
                ...
                <Tabs defaultValue="english" className="w-full">
                  <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="english">English Story</TabsTrigger>
                    <TabsTrigger value="persian">داستان فارسی (Persian)</TabsTrigger>
                  </TabsList>
                  <TabsContent value="english">
                    <ScrollArea className="h-80 p-4 border rounded-md bg-muted/50 mt-4">
                        <p className="text-muted-foreground whitespace-pre-wrap leading-relaxed">{story.englishStory}</p>
                    </ScrollArea>
                  </TabsContent>
                  <TabsContent value="persian">
                     <ScrollArea className="h-80 p-4 border rounded-md bg-muted/50 mt-4 text-right" dir="rtl">
