        ...
        <section id="global-vision" className="py-20 md:py-28 bg-secondary/50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Our journey begins with Persian and English, but our ambition knows no borders.
              </p>
            </div>
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <Card className="bg-background/80">
                <CardHeader>
                  <CardTitle>Expanding to New Languages</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-background/80">
                <CardHeader>
                  <CardTitle>An Invitation to the World</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    We extend a warm invitation to all English speakers and individuals from any linguistic background who are passionate about learning the rich Persian language. Join our community and become part of this creative and empowering journey.
                  </p>
                </CardContent>
              </Card>
            </div>
