      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
       ...
       <Card className="mt-8 bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
            <CardHeader>
                ...
                <CardDescription>
                    This is more than a leaderboard; it is a covenant with the first believers.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                <blockquote className="border-l-4 border-accent pl-4 text-lg italic text-foreground">
                   "Afarinesh and the city of Tavana will never forget those who first believed in it, sacrificed for it, and nurtured it like a newborn. It will forever be indebted to them and will make it a priority to repay its debts to those who fought for it, believed in it, and were the first to raise it up and announce it to the world."
                </blockquote>
                 <p className="text-muted-foreground">
                    Be assured that those who strive and sacrifice to introduce Afarinesh and the city of Tavana will be its founders, landowners, and most influential figures. They will be the ones who shape this city's identity and its decisions. Your efforts today build your legacy in the world of tomorrow.
                </p>
            </CardContent>
        </Card>
    </div>
