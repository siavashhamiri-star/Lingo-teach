...
3.  **A set of practical exercises:** Create a few exercises that directly relate to the lesson content to help the *student* practice. The complexity of these exercises should also be based on your analysis of the user. For exam prep topics, make sure to include "Sample Question" and "Model Answer" as exercise types.
