...
const ScriptLineSchema = z.object({
    speaker: z.string().describe('The speaker of the line (e.g., "User", "Barista"). Should be one of two speakers, User and another character.'),
              ...
              speakerVoiceConfigs: [
                {
                  speaker: 'User',
                  voiceConfig: {
                    prebuiltVoiceConfig: { voiceName: input.targetLanguage === 'Persian' ? 'Leyla' : 'Alfred' },
                  },
                },
                {
                  speaker: otherSpeakerName,
                  voiceConfig: {
                    prebuiltVoiceConfig: { voiceName: input.targetLanguage === 'Persian' ? 'Dariush' : 'Luna' },
                  },
                },
              ],
            },
